...
namespace Z21.Model
{
    public class TurnoutAdresse
    {
        ...
        public TurnoutAdresse(int adresse) => Value = adresse;

        public TurnoutAdresse(long adresse) => Value = (int)adresse;

        public TurnoutAdresse(ValueBytesStruct valueBytes) => ValueBytes = valueBytes;
        ...
        {
            set => Value = (value.Adr_MSB << 8) + value.Adr_LSB;
            get
            {
